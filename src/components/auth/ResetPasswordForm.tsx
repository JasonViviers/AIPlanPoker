...
export default function ResetPasswordForm({ onSwitch }: { onSwitch?: (view: 'login') => void }) {
  ...
  return (
    ...
    >
      <div className="flex items-center mb-6">
        ...
        <h2 className="text-2xl font-bold text-cyan-100 drop-shadow">Reset Password</h2>
      </div>
